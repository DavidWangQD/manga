...
class ControllerMangaManga extends Controller { 
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['banner'])) {
            ...
            $this->data['banner'] = $manga_info['banner'];
        } else {
            $this->data['banner'] = '';
        }
        ...
        if (isset($this->request->post['banner']) && file_exists(DIR_IMAGE . $this->request->post['banner'])) {
            $this->data['bannerThumb'] = $this->model_tool_image->resize($this->request->post['banner'], 100, 100);
        } elseif (!empty($manga_info) && $manga_info['banner'] && file_exists(DIR_IMAGE . $manga_info['banner'])) {
            $this->data['bannerThumb'] = $this->model_tool_image->resize($manga_info['banner'], 100, 100);
        } else {
            $this->data['bannerThumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
        }
