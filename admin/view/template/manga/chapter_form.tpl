                  ...
                  <td>
                      <select name="manga_id">
                          ...
                          <?php foreach($mangas as $manga) { ?>
                            <?php if($manga['manga_id'] == $manga_id) { ?>
                                <option value="<?php echo $manga['manga_id']; ?>" selected="selected"><?php echo $manga['title']; ?></option>
                            <?php }else{ ?>
                                <option value="<?php echo $manga['manga_id']; ?>"><?php echo $manga['title']; ?></option>
                            <?php } ?>
                          <?php } ?>
                      </select>
                      <?php if(isset($error_manga_id)) { ?>
                      <span class="error"><?php echo $error_manga_id; ?></span>
                      <?php } ?>
                  </td>
              </tr>
              <tr>
                  <td><span class="required">*</span> <?php echo $entry_num; ?></td>
                  <td><input type="text" name="num" value="<?php echo $num; ?>" />
                      <?php if(isset($error_num)) { ?>
                      <span class="error"><?php echo $error_num; ?></span>
                      <?php } ?></td>
              </tr>
              <tr>
